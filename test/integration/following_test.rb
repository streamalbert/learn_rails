...
class FollowingTest < ActionDispatch::IntegrationTest
  ...
  test "should follow a user with Ajax" do
    assert_difference '@user.following.count', 1 do
      # 12.2.6 Testing the Ajax version is almost the same, with xhr :post in place of plain post
      # This uses the xhr method (for XmlHttpRequest) to issue an Ajax request, 
